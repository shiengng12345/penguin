...
const STEPS = [
  {
    ...
    titleZh: "安装包",
    descEn: "Install gRPC-Web, gRPC, or JS-SDK packages from the sidebar.",
    descZh: "从侧边栏安装 gRPC-Web、gRPC 或 JS-SDK 包。",
    shortcut: "⌘ + S",
  },
  {
    icon: Globe,
    ...
    titleZh: "切换协议",
    descEn: "Cycle between gRPC-Web, gRPC, and JS-SDK with the protocol toggle. Use ⌘ + E for quick switching.",
    descZh: "使用协议切换在 gRPC-Web、gRPC 和 JS-SDK 之间切换。使用 ⌘ + E 快速切换。",
    shortcut: "⌘ + E",
  },
  {
    icon: Layers,
