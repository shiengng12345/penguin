...
const STEPS = [
  {
    ...
    titleZh: "安装包",
    descEn: "Install gRPC-Web, gRPC, or SDK packages from the sidebar. REST requests do not need packages.",
    descZh: "从侧边栏安装 gRPC-Web、gRPC 或 SDK 包。REST 请求不需要安装包。",
    shortcut: "⌘ + S",
  },
  {
    icon: Globe,
    ...
    titleZh: "切换协议",
    descEn: "Cycle between gRPC-Web, gRPC, SDK, and REST with the protocol toggle. Use ⌘ + E for quick switching.",
    descZh: "使用协议切换在 gRPC-Web、gRPC、SDK 和 REST 之间切换。使用 ⌘ + E 快速切换。",
    shortcut: "⌘ + E",
  },
  {
    icon: Layers,
