...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    titleZh: "切换协议",
    descEn: "Switch between gRPC-Web, gRPC, SDK, and REST. Press ⌘ + E four times and watch the tab badge change!",
    descZh: "在 gRPC-Web、gRPC、SDK 和 REST 之间切换。按 ⌘ + E 四次，观察标签徽章变化！",
